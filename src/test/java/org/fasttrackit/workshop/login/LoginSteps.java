...
public class LoginSteps extends TestBase {
    ...
    public void I_Expect_invalid_credential_message() {
        loginPage.errorMessageDisplayed("Invalid user or password!");
    }

    private void errorMessageShouldBePresent(String expectedMessage) {
        loginPage.errorMessageDisplayed(expectedMessage);
    }

    @When("^I enter \"([^\"]*)\"/\"([^\"]*)\" credentials$")
    public void I_enter_credentials(String emailValue, String passValue) {
        enterCredentials(emailValue, passValue);
    }

    private void enterCredentials(String emailValue, String passValue) {
